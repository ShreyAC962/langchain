...
# from langchain.agents.react.output_parsers import ReActSingleInputOutputParser
...
if __name__ == "__main__":
    ...
    intermediate_steps = []
    def parse_agent_output(agent_scratchpad):
    # If agent_scratchpad is a list of messages
